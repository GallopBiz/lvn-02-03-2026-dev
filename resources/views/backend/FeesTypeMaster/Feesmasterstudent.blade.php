...
<div class="main-content pt-4">
          <div class="breadcrumb">
            <h1 class="me-2">Student Fees Master</h1>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12 mb-4">
              <div class="form_section1_div">
                <form method="post" action="{{url('fees-registration-filter')}}">
                    @csrf
                    <div class="row">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu btn btn-danger " aria-labelledby="dropdownMenuButton"> <a class="dropdown-item " href="{{ route('feesmasterviewlist',$each_inq->id) }}">View</a>
