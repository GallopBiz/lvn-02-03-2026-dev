    ...
    <div id="printme">
        <div class="print-wrapper">
            <div class="header">
                ...
                <div style="font-size: 14px; font-weight: bold;">LOKMANYA VIDYA NIKETAN HIGHER SECONDARY SCHOOL</div>
                <div>LOKMANYA NAGAR, KESAR BAGH ROAD, INDORE (M.P.)</div>
                <div>Phone: 0731-2360169 | Email: lvnschoolofficial@gmail.com</div>
                <div><strong>Salary Slip Month: {{ $monthName }} {{ $report->year }}</strong></div>
            </div>
            ...
            <div class="section-table">
                ...
                <table>
                    ...
                    <tr>
                        <td>Basic Pay</td>
                        <td class="amount">{{ round(($report->gross_salary ?? 0) * 0.50) }}</td>
                    </tr>
                    ...
                    <tr>
                        <td>H.R.A</td>
                        <td class="amount">{{ round($report->hra ?? 0) }}</td>
                    </tr>
                    <tr>
                        <td>D.A</td>
                        <td class="amount">{{ round($report->da ?? 0) }}</td>
                    </tr>
                ...
                <table>
                    ...
                    <tr>
                        <td>EPFA</td>
                        <td class="amount">{{ round($report->epfa ?? 0) }}</td>
                    </tr>
                    <tr>
                        <td>ESIC</td>
                    ...
                    <tr>
                        ...
                        <td class="amount">{{ round(getD($deductions, 'Secr. Dep.')) }}</td>
                    </tr>
                    <tr>
                        <td>Grain Loan</td>
                        <td class="amount">{{ round(getD($deductions, 'Grain Loan')) }}</td>
                    </tr>
                    <tr>
                        <td>TDS</td>
                        <td class="amount">{{ round(getD($deductions, 'TDS')) }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="amount">{{ round(getD($deductions, 'Misc')) }}</td>
                    </tr>
                    <tr>
                        <td>Staff Ward</td>
                        <td class="amount">{{ round(getD($deductions, 'staff ward')) }}</td>
                    </tr>
                </table>
            </div>
            @php
