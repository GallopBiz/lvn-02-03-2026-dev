        ...
        <div class="form_section1_div">
            ...
            <div class="row">
                ...
                <div class="col-md-3 form-group mb-3">
                    ...
                    <input required class="form-control uperletter" id="department_name" name="department_name"
                        type="text"
                        @if (!empty($stream_master)) @foreach ($stream_master as $streammaster)
                      value="{{ $streammaster->department_name }}"
                    @endforeach
                  @else
                     @endif
                                ...
                                <tbody>
                                    ...
                                    @if (!empty($stream))
                                        @foreach ($stream as $streams)
                                            <tr>
                                                <td>{{ ++$i }}</td>
                                                <td class= "uperletter">{{ $streams->department_name }}</td>


                                                <td class='d-flex'>
                                                    <a class="btn btn-primary m-1"
                                                        href="{{ url('view-department') . '/' . $streams->id }}">Edit</a>
