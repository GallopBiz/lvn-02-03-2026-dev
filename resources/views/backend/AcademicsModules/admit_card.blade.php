...
<head>
    <style>
        ...
        * {
        ...
        .admit-card.bulk-card {
            height: 86mm;
            padding: 8px 10px;
        }

        .admit-card.single-card {
            width: 50%;
            height: 86mm;
            padding: 8px 10px;
            margin: 0 auto;
        ...
        .single-card .exam-title { font-size: 13px; }
        .bulk-card .sub-title,
            ...
            <div class="admit-card single-card">
                <div class="admit-card-inner">
                    ...
                    <div class="details">
                        ...
                        <p class="row-line">
                            <span>Class / Section :- {{ $student->class_name }} - {{ $student->section_name }}</span>
                            <span>Roll No. : {{ $student->roll_no }}</span>
                        </p>
                        <p>ROOM NO:- <span class="room-box">{{ $student->room_no ?? '-' }}</span></p>
                    </div>
